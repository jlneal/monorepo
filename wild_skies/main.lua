...
return function(mod)
  ...
  local function residentPicks(game, map, tod)
    ...
    local picks = flyingSlots(game, map.id, effectiveTod)
  ...
  local function seedResidentField(game, ow, neighbor)
    ...
    local picks, forest, town = residentPicks(game, map, ow.tod or "DAY")
